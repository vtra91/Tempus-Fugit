...
#Preview {
    TermBlock(imageList: ["testYourMight"], term: "Управление рисками", explanation: "Риски - это неслучившиеся потенциальные ситуации которые отрицательно или положительно способны сказаться на проекте. Делятся на высокие, средние, низкие. Случившийся риск - Проблема. Eсть 4 составляющих рисков: \n- Влияние рисков\n- Последствия рисков\n- Источник рисков\n- Счётотам рисков")
}
